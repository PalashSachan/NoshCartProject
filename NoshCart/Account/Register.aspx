            ...
            <asp:Panel runat="server" DefaultButton="RegisterButton">
                <div style="margin: 2px; border-color: white">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <asp:TextBox runat="server" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" ID="TextBoxNumber" ClientIDMode="Static" Width="100%" TextMode="Phone" MaxLength="10" Placeholder="9876-543210" CausesValidation="False" />
